...
export const PORTFOLIO_ASSET_TYPES: PortfolioAssetTypeMeta[] = [
  ...
  { id: "STOCK_US",      label: "Stocks US (Aristocrats)",     defaults: { expectedYield: 0.040, capitalGain: 0.06, taxRate: 0.300, volatility: 0.18 } },
  { id: "REIT_US",       label: "REITs US",                    defaults: { expectedYield: 0.050, capitalGain: 0.04, taxRate: 0.300, volatility: 0.18 } },
  { id: "ETF_US",        label: "ETFs US",                     defaults: { expectedYield: 0.020, capitalGain: 0.07, taxRate: 0.300, volatility: 0.16 } },
  { id: "RF_PUBLICO",    label: "Renda Fixa Tesouro/LCI",      defaults: { expectedYield: 0.115, capitalGain: 0.00, taxRate: 0.100, volatility: 0.05 } },
  { id: "RF_PRIVADO",    label: "Renda Fixa CDB/Debênture",    defaults: { expectedYield: 0.130, capitalGain: 0.00, taxRate: 0.175, volatility: 0.07 } },
  { id: "CUSTOM",        label: "Personalizado",               defaults: { expectedYield: 0.000, capitalGain: 0.00, taxRate: 0.000, volatility: 0.10 } },
];
